...
export const careerQuestions: { [key: string]: Question[] } = {
      ...
      answers: [
        {
          ...
          score: { frontend: 41, technical: 27, analysis: 20 },
        },
        {
          text: "B) updateState()",
          isCorrect: false,
          ...
          score: { frontend: 11, technical: 7, analysis: 7 },
        },
        {
          text: "C) changeState()",
          isCorrect: false,
      ...
      answers: [
        {
          ...
          score: { frontend: 41, technical: 27, innovation: 20 },
        },
        {
          text: "B) align-items",
          isCorrect: false,
          contribution: 0.05,
          focusAreas: ["technical"],
          score: { frontend: 11, technical: 7, innovation: 7 },
        },
        {
      ...
      answers: [
        {
          ...
          score: { frontend: 41, technical: 27, communication: 20 },
        },
        {
          text: "B) <div>",
          isCorrect: false,
          contribution: 0.05,
          focusAreas: ["technical"],
          score: { frontend: 11, technical: 7, communication: 7 },
        },
        {
          text: "C) <span>",
          isCorrect: false,
  ...
  backend: [
      ...
      answers: [
        {
          ...
          contribution: 0.15,
          focusAreas: ["technical", "analysis"],
          score: { backend: 41, technical: 27, analysis: 20 },
        },
        {
          text: "B) MERGE",
          isCorrect: false,
          contribution: 0.05,
          focusAreas: ["technical"],
          score: { backend: 11, technical: 7, analysis: 7 },
        },
        {
          text: "C) UNION",
          isCorrect: false,
    ...
    },
    {
      ...
      answers: [
        {
          text: "A) Index oluşturma",
          contribution: 0.15,
          focusAreas: ["technical", "analysis"],
          score: { backend: 41, technical: 27, analysis: 20 },
        },
        {
          text: "B) Sorguları önbelleğe alma",
          contribution: 0.15,
          focusAreas: ["technical", "analysis"],
          score: { backend: 41, technical: 27, analysis: 20 },
        },
        {
          text: "C) Her sorguyu ayrı ayrı çalıştırma",
          contribution: 0.05,
          focusAreas: ["technical"],
          score: { backend: 11, technical: 7, analysis: 7 },
        },
    ...
    },
    {
      ...
      answers: [
        {
          text: "A) JWT ile kimlik doğrulama",
          contribution: 0.15,
          focusAreas: ["technical", "siber"],
          score: { backend: 41, technical: 27, siber: 20 },
        },
        {
          text: "B) HTTPS kullanımı",
          contribution: 0.15,
          focusAreas: ["technical", "siber"],
          score: { backend: 41, technical: 27, siber: 20 },
        },
        {
          text: "C) Şifreleri açık metin olarak saklama",
          contribution: 0.05,
          focusAreas: ["technical"],
          score: { backend: 11, technical: 7, siber: 7 },
        },
      ],
    },
    {
    ...
    },
    {
      ...
      answers: [
        {
          text: "A) Her satırı benzersiz şekilde tanımlamak",
          isCorrect: true,
          contribution: 0.15,
          focusAreas: ["technical", "analysis"],
          score: { backend: 41, technical: 27, analysis: 20 },
  ...
  siber: [
      ...
      answers: [
        {
          ...
          contribution: 0.15,
          focusAreas: ["technical", "siber"],
          score: { siber: 41, technical: 27, analysis: 20 },
        },
        {
          text: "B) Kod inceleme",
          isCorrect: false,
          contribution: 0.05,
          focusAreas: ["technical"],
          score: { siber: 11, technical: 7, analysis: 7 },
        },
        {
          text: "C) Veritabanı yedekleme",
          isCorrect: false,
          contribution: 0.05,
          focusAreas: ["technical"],
          score: { siber: 11, technical: 7, analysis: 7 },
    ...
    },
    {
      ...
      answers: [
        {
          text: "A) Çok faktörlü kimlik doğrulama",
          contribution: 0.15,
          focusAreas: ["technical", "siber"],
          score: { siber: 41, technical: 27, analysis: 20 },
        },
        {
          text: "B) Güvenlik duvarı kullanımı",
          contribution: 0.15,
          focusAreas: ["technical", "siber"],
          score: { siber: 41, technical: 27, analysis: 20 },
        },
        {
          text: "C) Şifreleri düzenli olarak paylaşma",
          contribution: 0.05,
          focusAreas: ["technical"],
          score: { siber: 11, technical: 7, analysis: 7 },
        },
    ...
    },
    {
      ...
      answers: [
        ...
        {
          text: "C) Kullanıcı girişlerini filtreleme",
          isCorrect: false,
          contribution: 0.05,
          focusAreas: ["technical"],
          score: { siber: 11, technical: 7, analysis: 7 },
    ...
    },
    {
      ...
      answers: [
        {
          text: "A) IDS (Intrusion Detection System)",
          isCorrect: true,
          contribution: 0.15,
          focusAreas: ["technical", "siber"],
          score: { siber: 41, technical: 27, analysis: 20 },
    ...
    },
    {
      ...
      answers: [
        {
          text: "A) Kullanıcı eğitimi",
          contribution: 0.15,
          focusAreas: ["communication", "siber"],
          score: { siber: 41, communication: 27, analysis: 20 },
        },
        {
          text: "B) E-posta filtreleme",
          contribution: 0.15,
          focusAreas: ["technical", "siber"],
          score: { siber: 41, technical: 27, analysis: 20 },
        },
        {
          text: "C) Tüm e-postaları engelleme",
          contribution: 0.05,
          focusAreas: ["technical"],
          score: { siber: 11, technical: 7, analysis: 7 },
        },
    ...
    },
    {
      ...
      answers: [
        ...
        {
          text: "B) Şifreleri açık metin olarak saklama",
          isCorrect: false,
          contribution: 0.05,
          focusAreas: ["technical"],
          score: { siber: 11, technical: 7, analysis: 7 },
        ...
        {
          text: "C) Şifreleri düzenli olarak değiştirme",
          isCorrect: false,
          contribution: 0.05,
          focusAreas: ["technical"],
          score: { siber: 11, technical: 7, analysis: 7 },
